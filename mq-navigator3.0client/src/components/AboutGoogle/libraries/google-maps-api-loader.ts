...
export class GoogleMapsApiLoader {
   ...
   */
  static async load(params: ApiParams, onLoadingStatusChange: (status: APILoadingStatus) => void): Promise<void> {
  ...
  private static initImportLibrary(params: ApiParams) {
    ...
    const loadApi = () => {
      ...
      apiPromise = new Promise((resolve, reject) => {
        ...
        scriptElement.nonce = (document.querySelector('script[nonce]') as HTMLScriptElement)?.nonce || '';
